...
import time,random,sys,json,codecs,threading,glob,re,os,subprocess,urllib,requests,ast
...
cl = LINETCR.LINE()
cl.login(token="ErSiJJ9nvuQD6h87BJS2.iq9PtmlPUoEpJ8StTRzmCG.P9bUahXp6i006ac9ltSCev8jH9ZYj69alQIpzF35pPA=")
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE() #bot_12
ki.login(token="EqnRzxF6Sw4HI75XMBL7.vX6xvB+GQkkx5Zs4DXKU9W.DDXYj2MkwJJDHf0WkmIgQ2yF6lef7Sgn0l/t19re5Wg=")
ki.loginResult()
#print "ki-Login Success\n"

ki2 = LINETCR.LINE() #bot_13
ki2.login(token="Eq3Xokh51R5mWyA7DMCb.2zQPUth/iMWpYGvgLxR7cW.Lal0/YgEN7dNSyXKFjJSW8IijVGOkhzDKgMMRUxyCB4=")
ki2.loginResult()
...
║
║     ┏━━━━━━ೋ• ❄ •ೋ━━━━━━━┓
║     ✮      (̅_̅_̅(̲̲̲̲̲̅̅̅̅̅̅(̅_̅_̲̅F̲̅o̲̅я ̲̲̲̅̅̅̅ ̲̅G̲̅я̅ ̲̲̅̅o̲̅ ̲̅̅u̲̅ ̲̅̅p ̲̅̅ _̅_̅_̅() ڪے   ✮
║     ☾               ↓      ↓      ↓     ↓      ↓             ☽
║     ┗━━━━━━ೋ• ❄ •ೋ━━━━━━━┛
║
║† Cancel	
...
║† Kick:	
║† Vk:	「By Tag」
║† mayhem	「Startting anu」
║† Giftct	「Via send contact」
║† Gift10	「 By @」
╚════════════════════════╗
┏━━━━━━ೋ• ❄ •ೋ━━━━━━━┓
✮         <(▰ в o̴  т  ℭ⊚ℳℳαи₫▰)>   ✮
...
║  ┏━━━━━━━ೋ• ✮ •ೋ━━━━━━━━┓
║                 ✮꧁☾✮ℑυηγ❦℘✮☽✮
║   ❄ ✮Thankz For MyTeam✮™͙̳̳̳•̳ʀ͙̳ʏ͙̳s̸͙̳ʜ͙̳  ❄
║                            ✮  ❄  ✯
║  ┗━━━━━━━ೋ• ✮ •ೋ━━━━━━━━┛
╚════════════════════════╝
"""
...
DEF=[mid,kimid,ki2mid]
admsa = "ubd8fd5c6cb564f4260f6fe3e34ac5085"
admin = "ubd8fd5c6cb564f4260f6fe3e34ac5085",
juny = "ubd8fd5c6cb564f4260f6fe3e34ac5085"
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Thanks for add me!\n\n╔════════Open Order═════════\n║※ { Selfbot only }\n║※ { Selfbot + assist}\n║※ { Sablon Kaos }\n║※ { Sparasi undangan }\n║※ { berbagai macam sablon }\n╚═════════Contact Me═════════\n\n╔═════════════════════════\n\n⇨http://line.me/ti/p/~juny.love ☜\n⇨http://line.me/ti/p/~juny.love ☜\n⇨http://line.me/ti/p/~juny.love ☜\n\n╚═════════════════════════",
    "lang":"JP",
    "comment":"AutoLike by:⫷⚙™͙̳̳̳•̳ʀ͙̳ʏ͙̳s̸͙̳ʜ͙̳•̳ғ͙̳ᴀ͙̳ᴍ͙̳ɪ͙̳ʟ͙̳ʏ͙̳™͙̳̳̳⚙⫸",
    "commentOn":True,
    "likeOn":True,
    "commentBlack":{},
    "talkblacklist":{},
    ...
    "autoJoinTicket":True,
    "blacklist":{},
    "respon":"Berisik tag mulu, Sini Gift aja Langsung",
    "sidertag":"Haii\n⇱Ngintip Mulu sini chatt,Bintitan kapok Lu..!!!",
    "tag":True,
    "sticker":False,
    "wblacklist":False,
    "protect":False,
...
def updateProfilePicture(self, path, type='p'):
        ...
        r = self.post_content(self.server.LINE_OBS_DOMAIN + '/talk/p/upload.nhn', data=data, files=files)
        if r.status_code != 201:
...
def updateProfilePicture(self, path, type='p'):
        ...
        if type == 'vp':
            params.update({'ver': '2.0', 'cat': 'vp.mp4'})
        data = {'params': self.genOBSParams(params)}
        r = self.server.postContent(self.server.LINE_OBS_DOMAIN + '/talk/p/upload.jpg', data=data, files=files)
        if r.status_code != 201:
            raise Exception('Update profile picture failure.')
        return True
...
def bot(op):
    try:
	    ...
	    if mid in op.param3:
			...
			#ki.updateGroup(G)
			cl.sendText(op.param1,"Thankz for invite me on the Group  (　＾∇＾)")
	    else:
...
#------------------------[Welcome]----------------------------
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ubd8fd5c6cb564f4260f6fe3e34ac5085":
                    if "join:" in msg.text:
                ...
                if msg.from_ in admin:
                    ...
                    if cmd == "on":
                        ...
                        if mimic["status"] == True:
                            mimic["status"] = False
                            ki.sendText(msg.to,"「 Mimic Set to off ♨ 」")
                        else:
                            ki.sendText(msg.to,"「 Mimic Set to off ™ 」")
                    elif "add:" in cmd:
                        ...
                        if targets == []:
                            ki.sendText(msg.to,"「 Not in targets 」")
                        else:
                            for target in targets:
                                try:
...
#---------------------------------------
                ...
                van = "「Bot has been active」\n"+ waktu(eltime) 
                cl.sendText(msg.to,"「Type: Kalender♪」\n" + (wait2['setTime'][msg.to]) + "\n\n"+ van + "\n\n「Type: Name」\n" + contact.displayName + "\n\n「Type: Mid」\n" + contact.mid + "\n\n「Type: Bio」\n" + contact.statusMessage)
                cl.sendMessage(msg)      
            elif msg.text in ["Me"]:
                msg.contentType = 13
                msg.contentMetadata = {'mid': mid}
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"udah habis yak..??")
            elif "Sc" in msg.text:
            ...
            elif msg.text in ["Mygrup","Grouplist"]:
              if msg.from_ in admin:
                gid = cl.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "[✮] %s\n" % (cl.getGroup(i).name + " [ " + str (len (ki.getGroup(i).members)) + " ]")
                cl.sendText(msg.to,"        ꧁─━『 List Group 』━─꧂\n\n"+ h + "\n☾✮ Total Group: " + "["+ str(len(gid)) +"]")

            elif msg.text in ["Ki gc"]:
              if msg.from_ in admin:
            ...
            elif msg.text in ["Ki2 gc"]:
              if msg.from_ in admin:
                gid = ki2.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "[✮] %s\n" % (ki2.getGroup(i).name + " [ " + str (len (ki.getGroup(i).members)) + " ]")
                cl.sendText(msg.to,"        ꧁─━『 List Group 』━─꧂\n\n"+ h + "\n☾✮ Total Group: " + "["+ str(len(gid)) +"]")

            elif msg.text in ["Ki3 gc"]:
              if msg.from_ in admin:
                gid = ki3.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "[✮] %s\n" % (ki3.getGroup(i).name + " [ " + str (len (ki.getGroup(i).members)) + " ]")
                ki3.sendText(msg.to,"        ꧁─━『 List Group 』━─꧂\n\n"+ h + "\n☾✮ Total Group: " + "["+ str(len(gid)) +"]")

            elif msg.text in ["Ki4 gc"]:
              if msg.from_ in admin:
                gid = ki4.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "[✮] %s\n" % (ki4.getGroup(i).name + " [ " + str (len (ki.getGroup(i).members)) + " ]")
                ki4.sendText(msg.to,"        ꧁─━『 List Group 』━─꧂\n\n"+ h + "\n☾✮ Total Group: " + "["+ str(len(gid)) +"]")

            elif msg.text in ["Ki5 gc"]:
              if msg.from_ in admin:
                gid = ki5.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "[✮] %s\n" % (ki5.getGroup(i).name + " [ " + str (len (ki.getGroup(i).members)) + " ]")
                ki5.sendText(msg.to,"        ꧁─━『 List Group 』━─꧂\n\n"+ h + "\n☾✮ Total Group: " + "["+ str(len(gid)) +"]")

            elif msg.text in ["Ki6 gc"]:
              if msg.from_ in admin:
                gid = ki6.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "[✮] %s\n" % (ki6.getGroup(i).name + " [ " + str (len (ki.getGroup(i).members)) + " ]")
                ki6.sendText(msg.to,"        ꧁─━『 List Group 』━─꧂\n\n"+ h + "\n☾✮ Total Group: " + "["+ str(len(gid)) +"]")

            elif msg.text in ["Ki7 gc"]:
              if msg.from_ in admin:
                gid = ki7.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "[✮] %s\n" % (ki7.getGroup(i).name + " [ " + str (len (ki.getGroup(i).members)) + " ]")
                ki7.sendText(msg.to,"        ꧁─━『 List Group 』━─꧂\n\n"+ h + "\n☾✮ Total Group: " + "["+ str(len(gid)) +"]")

            elif msg.text in ["Ki8 gc"]:
              if msg.from_ in admin:
                gid = ki8.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "[✮] %s\n" % (ki8.getGroup(i).name + " [ " + str (len (ki.getGroup(i).members)) + " ]")
                ki8.sendText(msg.to,"        ꧁─━『 List Group 』━─꧂\n\n"+ h + "\n☾✮ Total Group: " + "["+ str(len(gid)) +"]")

            elif msg.text in ["Ki9 gc"]:
              if msg.from_ in admin:
                gid = ki9.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "[✮] %s\n" % (ki9.getGroup(i).name + " [ " + str (len (ki.getGroup(i).members)) + " ]")
                ki9.sendText(msg.to,"        ꧁─━『 List Group 』━─꧂\n\n"+ h + "\n☾✮ Total Group: " + "["+ str(len(gid)) +"]")

            elif msg.text in ["Gruplistmid"]:   
                gruplist = cl.getGroupIdsJoined()
                kontak = cl.getGroups(gruplist)
                geger = kontak.members
                num=1
                msgs="═════════List GrupMid═════════"
                for ids in kontak:
                    msgs+="\n[%i] %s" % (num, ids.id)
            ...
            elif "Get member: " in msg.text:
                saya = msg.text.replace('Get member: ','')
                gid = cl.getGroupIdsJoined()
                for i in gid:
            ...
            elif "Ki member: " in msg.text:
                saya = msg.text.replace('Ki member: ','')
                gid = ki.getGroupIdsJoined()
                for i in gid:
            ...
            elif "Ki2 member: " in msg.text:
                saya = msg.text.replace('Ki2 member: ','')
                gid = ki2.getGroupIdsJoined()
                for i in gid:
                    h = ki2.getGroup(i).name
                    gna = ki2.getGroup(i)
                    geger = gna.members
                    num = 1
                    gg = ""
                ...
                if wait["autoJoin"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Hal ini sudah tertutup ô€¨👈")
                else:
                    wait["autoJoin"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already OFF􀜁􀇔􏿿")
                    else:
                        cl.sendText(msg.to,"It is already OFF ô€¨")
...
#==============[Baru]==============
                ...
                future = datetime(2018,02,28)
                days = (str(future - today))
                comma = days.find(",")
                days = days[:comma]
                cl.sendText(msg.to,"「About」\n 「™͙̳̳̳•̳ʀ͙̳ʏ͙̳s̸͙̳ʜ͙̳」Selfbot edition \n\n「Subscription」\n Sisa Aktif SB kamu: " + "\n In days: " + days +  "\n\n「Contact Creator」\n➭: line://ti/p/~juny.love")
                msg.contentType = 13
                msg.contentMetadata = {'mid':mid}
                cl.sendMessage(msg)
                    ...
                    for mention in mentionees:
                      for x in range(len(cgroup)):
                        ...
                        if mention['M'] in gMembMids:
                            ngroup += "\n「 ➣ 」" + cgroup[x].name + "「➸」 " + str(len(cgroup[x].members))
                    if ngroup == "":
                          cl.sendText(msg.to, "「 NOT FOUND 」")
                    else:
                        cl.sendText(msg.to,"「List Group Yg Sama」:\n%s\n"%(ngroup))
                        
            elif msg.text.lower().startswith("jadwal sholat: "):
                location = msg.text.lower().replace("jadwal sholat: ","")
            ...
            elif msg.text.lower().startswith("suhu: "):
                location = msg.text.lower().replace("suhu: ","")
                with requests.session() as web:
                    web.headers["user-agent"] = "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36"
                    ...
                    cl.sendText(msg.to, str(ret_))
            elif msg.text.lower().startswith("location: "):
                location = msg.text.lower().replace("location: ","")
                with requests.session() as web:
                    web.headers["user-agent"] = "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36"
...
#=================[Easy mode]=========================#
              ...
              if msg.from_ in admin:
                ...
                if wait["ricoinvite"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"「 Invite by send contact turn on 」")
                    else:
                        cl.sendText(msg.to,"「 Invite by send contact turn on 」")
                else:
                    wait["ricoinvite"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"「 Invite by send contact turn off 」")
                    else:
                        cl.sendText(msg.to,"「 Invite by send contact turn off 」")
              ...
              if msg.from_ in admin:
                ...
                if wait["dblacklist"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"「 Unban by send contact turn on 」")
                    else:
                        cl.sendText(msg.to,"「 Unban by send contact turn on 」")
                else:
                ...
                if wait["dblacklist"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"「 Unban by send contact turn off 」")
                    else:
                        cl.sendText(msg.to,"「 Unban by send contact turn off 」")
                else:
                    wait["dblacklist"] = False
              ...
              if msg.from_ in admin:
                ...
                if wait["protectqr"] == True: md+="║☞ Protect link → ✔\n"
                ...
                if wait["Protectgr"] == True: md+="║☞ ProtectGhuest → ✔\n"
                else:md+="║☞ ProtectGhuest → ❌\n"
                if wait["welcome"] == True: md+="║☞ Welcomeimg → ✔\n"
                else:md+="║☞ Welcomeimg→ ❌\n"
                ...
                cl.sendText(msg.to,"􀀷􀰂􀰂􀰂􀰂➣My Owner bot⤵⤵\n\n☾✮ℑυηγ❦℘✮☽􀂳􏿿􀀷")
                msg.contentType = 13
                msg.contentMetadata = {'mid':juny}
                cl.sendMessage(msg)
...
#==================================Sticker==================================================================   
              ...
              if msg.from_ in admin:
                if wait["sticker"] == True:
                    ...
                    wait["sticker"]=True
                    cl.sendText(msg.to, "Detect sticker id active.\n\n"+ datetime.today().strftime('%H:%M:%S')) 
...
#=================================Detect stiker Finish====================================================================
              ...
              if msg.from_ in admin and Bots:
                ...
                c = msg.text.replace("Respon set: ","")
                if c in [""," ","\n",None]:
                    cl.sendText(msg.to,"Respon has been set")
                else:
                    wait["respon"] = c
                    cl.sendText(msg.to,"change respon\n\n" + c)
            elif "Sider set: " in msg.text:
                c = msg.text.replace("Sider set: ","")
                if c in [""," ","\n",None]:
                    cl.sendText(msg.to,"⇱Sidertag has been set⇲")
                else:
                    wait["sidertag"] = c
                    cl.sendText(msg.to,"Sidertag change to ⇲\n\n" + c)
            elif "Ver: " in msg.text:
                c = msg.text.replace("Ver: ","")
                if c in [""," ","\n",None]:
                    cl.sendText(msg.to,"Sticker Tag has been set")
                else:
                    tikel["STKVER"] = c
                    cl.sendText(msg.to,"Sticker telah di set" + c)
            elif "Gid: " in msg.text:
                c = msg.text.replace("Gid: ","")
                if c in [""," ","\n",None]:
                    cl.sendText(msg.to,"Sticker Tag has been set")
                else:
                    tikel["STKPKGID"] = c
                    cl.sendText(msg.to,"Sticker telah di set" + c)
            elif "Kid: " in msg.text:
                c = msg.text.replace("Kid: ","")
                if c in [""," ","\n",None]:
                    cl.sendText(msg.to,"Sticker Tag has been set")
                else:
                    tikel["STKID"] = c
            ...
            elif msg.text.lower() == "ki glist":
                gs = ki.getGroupIdsJoined()
                num=1
                L = "⚛『 Groups-⚚-List 』⚛\n"
                for i in gs:
                    L += "\n%i. %s\n%s\n" % (num, ki.getGroup(i).name + " | " + str(len (ki.getGroup(i).members)), i)
                    num=(num+1)
                L += "\n\n☫ Total Groups : [ %i ]" % len(gs)
                ki.sendText(msg.to, L + "\n\n                   °✍ℑυℌϒ·✡ ") 
            elif "Ki invite :" in msg.text:
              if msg.from_ in admin:
                gid = msg.text.replace("Ki invite :","")
                if gid == "":
            ...
            elif msg.text.lower() == "ki2 glist":
                gs = ki2.getGroupIdsJoined()
                num=1
                L = "⚛『 Groups-⚚-List 』⚛\n"
                for i in gs:
                    L += "\n%i. %s\n%s\n" % (num, ki2.getGroup(i).name + " | " + str(len (ki2.getGroup(i).members)), i)
                    num=(num+1)
                L += "\n\n☫ Total Groups : [ %i ]" % len(gs)
                ki2.sendText(msg.to, L + "\n\n                   °✍ℑυℌϒ·✡ ") 
            elif "Ki2 invite: " in msg.text:
              if msg.from_ in admin:
                gid = msg.text.replace("Ki2 invite: ","")
                if gid == "":
            ...
            elif msg.text.lower() == "ki3 glist":
                gs = ki3.getGroupIdsJoined()
                num=1
                L = "⚛『 Groups-⚚-List 』⚛\n"
                for i in gs:
                    L += "\n%i. %s\n%s\n" % (num, ki3.getGroup(i).name + " | " + str(len (ki3.getGroup(i).members)), i)
                    num=(num+1)
                L += "\n\n☫ Total Groups : [ %i ]" % len(gs)
                ki3.sendText(msg.to, L + "\n\n                   °✍ℑυℌϒ·✡ ") 
            elif "Ki3 invite: " in msg.text:
              if msg.from_ in admin:
                gid = msg.text.replace("Ki3 invite: ","")
                if gid == "":
            ...
            elif msg.text.lower() == "ki4 glist":
                gs = ki4.getGroupIdsJoined()
                num=1
                L = "⚛『 Groups-⚚-List 』⚛\n"
                for i in gs:
                    L += "\n%i. %s\n%s\n" % (num, ki4.getGroup(i).name + " | " + str(len (ki4.getGroup(i).members)), i)
                    num=(num+1)
                L += "\n\n☫ Total Groups : [ %i ]" % len(gs)
                ki4.sendText(msg.to, L + "\n\n                   °✍ℑυℌϒ·✡ ") 
            elif "Ki4 invite: " in msg.text:
              if msg.from_ in admin:
                gid = msg.text.replace("Ki4 invite: ","")
                if gid == "":
            ...
            elif msg.text.lower() == "ki5 glist":
                gs = ki5.getGroupIdsJoined()
                num=1
                L = "⚛『 Groups-⚚-List 』⚛\n"
                for i in gs:
                    L += "\n%i. %s\n%s\n" % (num, ki5.getGroup(i).name + " | " + str(len (ki5.getGroup(i).members)), i)
                    num=(num+1)
                L += "\n\n☫ Total Groups : [ %i ]" % len(gs)
                ki5.sendText(msg.to, L + "\n\n                   °✍ℑυℌϒ·✡ ") 
            elif "Ki5 invite: " in msg.text:
              if msg.from_ in admin:
                gid = msg.text.replace("Ki5 invite: ","")
                if gid == "":
            ...
            elif msg.text.lower() == "ki6 glist":
                gs = ki6.getGroupIdsJoined()
                num=1
                L = "⚛『 Groups-⚚-List 』⚛\n"
                for i in gs:
                    L += "\n%i. %s\n%s\n" % (num, ki6.getGroup(i).name + " | " + str(len (ki6.getGroup(i).members)), i)
                    num=(num+1)
                L += "\n\n☫ Total Groups : [ %i ]" % len(gs)
                ki6.sendText(msg.to, L + "\n\n                   °✍ℑυℌϒ·✡ ") 
            elif "Ki6 invite: " in msg.text:
              if msg.from_ in admin:
                gid = msg.text.replace("Ki6 invite: ","")
                if gid == "":
                  ki6.sendText(msg.to,"Invalid group id")
                else:
                  try:
            ...
            elif msg.text.lower() == "ki7 glist":
                gs = ki7.getGroupIdsJoined()
                num=1
                L = "⚛『 Groups-⚚-List 』⚛\n"
                for i in gs:
                    L += "\n%i. %s\n%s\n" % (num, ki7.getGroup(i).name + " | " + str(len (ki7.getGroup(i).members)), i)
                    num=(num+1)
                L += "\n\n☫ Total Groups : [ %i ]" % len(gs)
                ki7.sendText(msg.to, L + "\n\n                   °✍ℑυℌϒ·✡ ") 
            elif "Ki7 invite: " in msg.text:
              if msg.from_ in admin:
                gid = msg.text.replace("Ki7 invite: ","")
                if gid == "":
                  ki7.sendText(msg.to,"Invalid group id")
                else:
                  try:
                    ki7.findAndAddContactsByMid(msg.from_)
                    ki7.inviteIntoGroup(gid,[msg.from_])
                  except:
                    ki7.sendText(msg.to,"Mungkin saya tidak di dalaam grup itu")

            elif msg.text.lower() == "ki8 glist":
                gs = ki8.getGroupIdsJoined()
                num=1
                L = "⚛『 Groups-⚚-List 』⚛\n"
                for i in gs:
                    L += "\n%i. %s\n%s\n" % (num, ki8.getGroup(i).name + " | " + str(len (ki8.getGroup(i).members)), i)
                    num=(num+1)
                L += "\n\n☫ Total Groups : [ %i ]" % len(gs)
                ki8.sendText(msg.to, L + "\n\n                   °✍ℑυℌϒ·✡ ") 
            elif "Ki8 invite: " in msg.text:
              if msg.from_ in admin:
                gid = msg.text.replace("Ki8 invite: ","")
                if gid == "":
                  ki8.sendText(msg.to,"Invalid group id")
                else:
                  try:
                    ki8.findAndAddContactsByMid(msg.from_)
                    ki8.inviteIntoGroup(gid,[msg.from_])
                  except:
                    ki8.sendText(msg.to,"Mungkin saya tidak di dalaam grup itu")

            elif msg.text.lower() == "ki9 glist":
                gs = ki9.getGroupIdsJoined()
                num=1
                L = "⚛『 Groups-⚚-List 』⚛\n"
                for i in gs:
                    L += "\n%i. %s\n%s\n" % (num, ki9.getGroup(i).name + " | " + str(len (ki9.getGroup(i).members)), i)
                    num=(num+1)
                L += "\n\n☫ Total Groups : [ %i ]" % len(gs)
                ki9.sendText(msg.to, L + "\n\n                   °✍ℑυℌϒ·✡ ") 
            elif "Ki9 invite: " in msg.text:
              if msg.from_ in admin:
                gid = msg.text.replace("Ki9 invite: ","")
                if gid == "":
                  ki9.sendText(msg.to,"Invalid group id")
                else:
                  try:
                    ki9.findAndAddContactsByMid(msg.from_)
                    ki9.inviteIntoGroup(gid,[msg.from_])
                  except:
                    ki9.sendText(msg.to,"Mungkin saya tidak di dalaam grup itu")
...
#----------------------ADMIN COMMAND------------------------------#
                ...
                #kl.sendText(msg.to,"Spam tag mulu ikh..\nIkut iseng tag juga ya 😁...")
                group = cl.getGroup(msg.to)
                nama = [contact.mid for contact in group.members]
                cb = ""
                cb2 = ""
                ...
                try:
                    ...
                    print error
                #kl.sendText(msg.to,"Tugas untuk absen udah kelar nah kak, pamit ya... 😉")
                #cl.sendText(msg.to,"Dor")
...
#--------Tag Leave Done--------------------
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"「 Sider Mode Diaktifkan  」")
                
            elif "Sider off" in msg.text:
                if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    cl.sendText(msg.to, "「 Sider Mode dinonaktifkan 」")
                else:
        ...
        #======Translate=========#
             ...
             if msg.from_ in admin:
               ...
               for target in targets:
                ...
                ki.sendText(msg.to,"「Chat Bot turned on ♪♪」")
                
            elif msg.text in ["Simi off","simi off"]:
                settings["simiSimi"][msg.to] = False
                ki.sendText(msg.to,"「Chat Bot turned off ♩♩」")
...
#===========[PAP IS DONE]===============
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    msg.contentType = 0
                    ryan0 = msg.text.replace("Steal dp ","")
                    ryan1 = ryan0.lstrip()
                    ryan2 = ryan1.replace("@","")
                    ryan3 = ryan2.rstrip()
                    _name = ryan3
                    ryan = cl.getGroup(msg.to)
                    targets = []
                    for g in ryan.members:
                        if _name == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                contact = cl.getContact(target)
                                cl.sendText(msg.to,"http://dl.profile.line-cdn.net/" + contact.pictureStatus)
                                try:
                                    image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                                except:
                                    image = "https://www.1and1.co.uk/digitalguide/fileadmin/DigitalGuide/Teaser/not-found-t.jpg"
	           ...
	           if msg.from_ in admin:
                ...
                path = str(cu)
                path2 = str(cu)
                hh = cl.getContact(mid)
                cu2 = cl.channel.getCover(mid)          
                path2 = str(cu2)
            ...
            elif 'hentai' in msg.text:
                ngentod = "https://g.e-hentai.org/g/448142/133593baa5/"
                cl.sendImageWithURL(msg.to,ngentod)
                ...
                if msg.from_ in admin:
                    path = "jpg"
                    cl.sendText(msg.to,"「 Send picture for update profile  」")
            ...
            elif "Allcopy @" in msg.text:
                if msg.toType == 2:
                    if msg.from_ in admin:
                        print "[BOT COPY] Ok"
                        _name = msg.text.replace("Allcopy @","")
                        _nametarget = _name.rstrip('  ')
...
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ki9.updateProfile(profile)
                    cl.sendText(msg.to,"Sucsess change Name to ⇨ " + string + "")
...
#-------------------Fungsi spam start--------------------------
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to, "「Debug Speed」\nType : speed\nTIME TAKKEN : %ssᴇᴄᴏɴᴅs♪♪" % (elapsed_time))     
            

            elif msg.text in ["Mybio"]:
            	msg.contentType = 13
                msg.contentMetadata = {'mid': mid}
                cl.sendText(msg.to,"       「 INFO CREATOR 」\n\n★→LINE: http://line.me/ti/p/~juny.love ☜\n★→WhatsApp: 081217991309 ☜\n★→Nama: Juny Syahputra ☜\n★→TTL: Tuban, 13 Juny 19×× ☜\n★→Asal Daerah: Jawa Timur ☜\n★→Usia: Pc aja kali aja seumuran ツ ☜\n★→Zodiak: →Gemini ☆")
                #cl.sendMessage(msg)
                random.choice(KAC).sendText(msg.to, "Biodata My creator ⤴")
                ...
                if wait["lang"] == "JP":
                    if ginfo.invitee is None:
                        ...
                        ricoinvitee = str(len(ginfo.invitee))
                msg.contentType = 13
                msg.contentMetadata = {'mid': ginfo.creator.mid}
                cl.sendText(msg.to,"[Nama]\n" + str(ginfo.name) + "\n[Group Id]\n" + msg.to + "\n\n[Group Creator]\n" + gCreator + "\n\nAnggota:" + str(len(ginfo.members)) + "\nInvitation:" + ricoinvite + "")
                cl.sendMessage(msg)
            elif msg.text == "Uni":
              ...
              if msg.from_ in admin:
                ...
                random.choice(KAC).sendText(msg.to,"「 Send Contact For Invite 」 ")
...
#-----------------------------------------------------------
                ...
                elapsed_time = time.time() - start
                ki5.sendText(msg.to, "Mohon Bersabar Ini Gratisan...")
                elapsed_time = time.time() - start
 ...
 #-----------------------------------------------
                        ...
                        time.sleep(0.001)
                        random.choice(KAC).sendText(msg.to,"Hallo 🤗 " + "☞ " + str(ginfo.name) + " ☜")
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = True
                ...
                try:
					...
					ki2.leaveGroup(msg.to)
                     ...
                     pass 
#--------------------------------
            elif msg.text in ["#Bye","/bye","/Leave"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                ...
                if msg.toType == 2:
                    ...
                    for g in gs.members:
                        if _name in g.displayName:
                           targets.append(g.mid)
                    if targets == []:
                        cl.sendText(msg.to,"Tidak ada member lain selain lu bego")
                    else:
                        for target in targets:
                            try:
                                wait["blacklist"][target] = True
                                ...
                                #cl.sendText(msg.to,"Success Banned")
                            except:                               
                                cl.sendText(msg.to,"Error")                                                                                                 
                    cl.sendText(msg.to,"Success Banned All Member & Block url off \n\n"+ datetime.today().strftime('%H:%M:%S'))                  
...
#-------------------------------------------------------------------                            
                    ...
                    print "[Command]Like executed"
                    try:
                        cl.sendText(msg.to,"「 Restarting Bot Progams♩ 」♪♪")
                        restart_program()
                    except:
...
#--------------------------[Youtube]---------------------
            ...
            elif 'Ytb: ' in msg.text:
                    try:
                        textToSearch = (msg.text).replace('Ytb: ', "").strip()
                        query = urllib.quote(textToSearch)
                        url = "https://www.youtube.com/results?search_query=" + query
                        response = urllib2.urlopen(url)
                        html = response.read()
...
#------------------------------- UNBAN BY TAG -------------------------------
            ...
            elif msg.text in ["Clear ban","Del"]:
              if msg.from_ in admin:
                wait["blacklist"] = {}
                cl.sendText(msg.to,"「 Unbaned sucsess 」\n\n"         "List Banned  Total ☑「 0 」☜")
                ...
                if wait["blacklist"] == {}:
                    ...
                    cl.sendText(msg.to,"「 List Banlist 」")
                    num=1
                    msgs="══════════List Blacklist═════════"
                    ...
                    cl.sendText(msg.to, msgs)
            elif msg.text in ["Conban","Contactban","Contact ban","Blc"]:
                if wait["blacklist"] == {}:
                    cl.sendText(msg.to,"「 ↘Nothing blacklist user↖ 」")
                else:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    for tag in wait["blacklist"]:
                        matched_list+=filter(lambda str: str == tag, gMembMids)
                    if matched_list == []:
                        cl.sendText(msg.to,"「 ◈Not user Blacklist ツ◈ 」")
                        return
                    for jj in matched_list:
                        try:
				...
				OWN = "ue9ce05bcb50fd4c739e8012923205804"
				if msg.from_ in OWN:
					pass
				else:
					nk0 = msg.text.replace("Ki ","")
					nk1 = nk0.lstrip()
					nk2 = nk1.replace("@","")
					nk3 = nk2.rstrip()
					_name = nk3
                        ...
                        for target in targets:
                            if not target in Bots:
                                try:
                                   ...
                                   ki.sendText(msg.to,"「 Mayhem  done ツ」")
                ...
                if op.param3 in Lmid:
                  if op.param2 not in Bots or admin:
                    try:
                      ...
                      G.preventJoinByTicket = False
                      kl.updateGroup(G)
                      Ticket = kl.greissueGroupTicket(op.param1)
                      ...
                      G = random.choice(KAC).getGroup(op.param1) #Salsa Bertindak
                      ...
                      random.choice(KAC).acceptGroupInvitationByTicket(op.param1,Ticket)
                      time.sleep(0.00001)
                      cl.sendText(op.param1, "Thankz sayang")
                      kl.sendText(op.param1, "Sama² bebz")
                      kl.sendText(op.param1, "Ya udah aq balik dulu\nAssalamualaikum")
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != {'mid': mid}:
                 if wait["detectMention"] == True:
                    ...
                    balas = "@"+xname+ "\n\n「 Jones ↑ 」\n\n","@"+xname+ "\n\n「 Jones ↑ 」\n\n"
                    path = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                    msg.text = random.choice(balas)+str(wait["respon"])
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention['MENTIONEES']
                    for mention in mentionees:
                ...
                try:
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            Name = random.choice(KAC).getContact(op.param2).displayName
...
def autoSta():
    ...
    while True:
        try:
           for posts in cl.activity(66)["result"]["posts"]:
